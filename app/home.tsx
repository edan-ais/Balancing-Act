...
import { CalendarDays, Calendar, ChefHat, Sparkles, Target, Heart, Users, ArrowRight, Palette, Coffee, CloudRain, User, LogOut, Leaf } from 'lucide-react-native';
...
const getThemeIcon = (themeId: string): LucideIcon => {
  switch (themeId) {
              ...
              >
                <NeumorphicCard style={[
                  ...
                  <View style={[
                    ...
                    <ThemeIcon size={22} color={isSelected ? themeColors.pastel : primaryColors.pastel} />
                  </View>
                  <Text style={[
                    styles.themeTitle,
...
const styles = StyleSheet.create({
  ...
  authButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, shadowOffset: { width: 2, height: 2 }, shadowOpacity: 0.2, shadowRadius: 3, elevation: 3, minWidth: 120 },
  ...
  continueButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', margin: 16, padding: 16, borderRadius: 14, shadowOffset: { width: 3, height: 3 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 6 },
